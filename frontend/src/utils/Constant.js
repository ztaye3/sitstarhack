...
export const GET_USER_URL = "/get-user-profile/";
export const SIGNUP_URL = "/create-user/";
export const LOGOUT_URL = "/api/auth/v1/token/logout/";
export const AUTH_LOGIN_REDIRECT_URL = "/login/?next=";
export const ACTIVATE_ACCOUNT_URL = "/verify-user/";
...
export const LOGIN_USER_FRONTEND = "/login"
export const SEARCH_FRONTEND = "/"
