...
import {DASHBOARD_URL, HOME_URL, SEARCH_FRONTEND} from "../../utils/Constant";
...
class Login extends Component {
    ...
    onLoginClick = e =>{
        ...
        this.props.loginUserAction(userInput, SEARCH_FRONTEND)
    }
    render() {
        ...
        return <Redirect to={SEARCH_FRONTEND} />
            }
        return (
